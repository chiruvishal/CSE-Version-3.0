    ...
    <>
      <div>
        <div
          ...
          style={{
            backgroundImage: "url(https://i.postimg.cc/8ctSVW0H/w14-2.jpg)",
          }}
        >
          ...
          <div className="nitr-page-title-container green destinations-section-wrapper nitr-container ">
            ...
            >
              <div className="green-line-text Contact-text"> Contact Us </div>{" "}
            </div>{" "}
          </div>{" "}
        </div>{" "}
              ...
              <form action="/" autoComplete="off" onSubmit={handleSubmit}>
                ...
                <div className="input-containert">
                  <input
                    ...
                    onBlur={blurFunc}
                  />{" "}
                  <label htmlFor=""> Username </label> <span> Username </span>{" "}
                </div>{" "}
                <div className="input-containert">
                  <input
                    type="email"
                    ...
                    onBlur={blurFunc}
                  />{" "}
                  <label htmlFor=""> Email </label> <span> Email </span>{" "}
                </div>{" "}
                <div className="input-containert">
                  <input
                    type="tel"
                    ...
                    onBlur={blurFunc}
                  />{" "}
                  <label htmlFor=""> Phone </label> <span> Phone </span>{" "}
                </div>{" "}
                <div className="input-containert textareat">
                  <textarea
                    ...
                    onBlur={blurFunc}
                  />{" "}
                  <label htmlFor=""> Message </label> <span> Message </span>{" "}
                </div>
                <input
                  type="submit"
