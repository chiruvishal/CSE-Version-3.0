...
const ContactInformation = () => {
    ...
    return ( <
        ...
        style = {
            {
                backgroundImage: 'url(https://i.postimg.cc/3xLLr2XH/image-5.png)',
            }
        } >
        <
        ...
        <
        div className = "nitr-page-title-content nitr-item-pdlr"
        style = {
            { paddingBottom: '60px' }
        } >
        <
        ...
        <
        img src = "https://i.postimg.cc/YqNjggfW/SHAPE11.png"
        className = "squaret"
        alt = "" /
        >
        <
        ...
        with us.Our team is here to assist you and provide the information you need.We value your input and look forward to connecting with you!
        <
        /p> <
        div className = "infot" >
        <
        ...
        <
        img src = "https://i.postimg.cc/kg9qdpSV/LOCATION11.png"
        className = "icont"
        alt = "" /
        >
        <
        ...
        div className = "informationt" >
        <
        img src = "https://i.postimg.cc/C1x3KyM1/EMAIL11.png"
        className = "icont"
        alt = "" /
        >
        <
        ...
        div className = "informationt" >
        <
        img src = "https://i.postimg.cc/hv6WwCBG/PHONE11.png"
        className = "icont"
        alt = "" /
        >
        <
