...
export default function CourseOverview() {
    ...
    return ( <
        ...
        style = {
            {
                backgroundImage: "url(https://i.postimg.cc/x1sfgTzb/Untitled-design-4.jpg)",
            }
        } >
        <
        ...
        <
        button className = { toggleState === 1 ? "tabsx active-tabsx" : "tabsx" }
        onClick = {
            () => toggleTab(1) } >
        Curriculum <
        /button> <
        button className = { toggleState === 2 ? "tabsx active-tabsx" : "tabsx" }
        onClick = {
            () => toggleTab(2) } >
        Schedule <
        /button> <
