  ...
  return (
    ...
    <div className="student-section">
      ...
      <div className="student-box">
        ...
        <a className="student-link" href="#">MIS</a>
        <a className="student-link" href="#">Latest result</a>
        <a className="student-link" href="#">Internship at NIT Raipur</a>
        <a className="student-link" href="#">Scholarships for students</a>
        <a className="student-link" href="#">Resource 5</a>
        <a className="student-link" href="#">Resource 6</a>
      </div>
      ...
      <table className="contacts-table">
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>Assistant Registrar ( Email id: studentsection@nitrr.ac.in, asstreg.ss@nitrr.ac.in )   </td>
              <td>+91-9981544944   </td>
            </tr>
            <tr>
              <td>13</td>
