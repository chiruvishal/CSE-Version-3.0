        ...
        <div class="drop">
            <div className="Aiml">
              ...
              {/* <div id="director-message" className="containerw mx-auto my-10"> */}
               <div className="flexw flex-colw space-y-6 rounded-lg bg-light-purple overflow-hidden shadow-md md:flex-row md:space-y-0 md:space-x-6">
                ...
                <div id="content" className="flex flex-colw basis-8/12 space-y-4 p-6">
                   <p className="mess">
                    ...
                    & Bhubneshwar by regular flights and is on the main
                    Howrah-Mumbai railway line route. The institute is 5 km from
                    Raipur railway station and 14 km from airport on NH-6, the
                    Great Eastern Road.
                   </p>
                </div>
              </div>
            ...
            <div className="Aiml">
              ...
              <div className="flexi flex-colw space-y-6 rounded-lg bg-light-purple overflow-hidden shadow-md md:flex-row md:space-y-0 md:space-x-6">
                <div className="pic">
                  <img
                    src="https://i.postimg.cc/4ybHJgpM/nehru2.gif"
                    className="basis-4/12 h-full w-full object-cover hodimg"
                    alt="college"
                  />
                </div>
                ...
                >
                  <p className="mess">
                    The first President of independent India honorable Dr.
                    Rajendra Prasad laid the Foundation stone of the college
                    building on 14th September 1956. The construction work was
                    completed in 1962 and inauguration was on 14th March 1963 by
                    India's first Prime Minister Pt. Jawaharlal Nehru. After
                    independence and with reorganisation of the state of Madhya
                    Pradesh, the government attention was directed towards
                    giving priority to overall development of technical
                    education.
                  </p>
                </div>
                <p class="ab">
                  Till as late as 1956 there were only three technical
                  institutes in the country offering courses in the important
                  fields of Mining and Metallurgical Engineering. In view of
                  this fact and also with an aim of harnessing the ample mineral
                  resources of the region, this institute was set-up on 1st May
                  1956 as Government College of Mining and Metallurgy. The first
                  session of the college commenced from 1st July 1956 with the
                  admission of 15 students each in Mining and Metallurgy
                  Engineering.
                  <div style={{ margin: '20px 0' }}></div>
                  In 1958-59 with the commencement of additional courses in
                  Civil, Mechanical and Electrical Engineering the college came
                  to be known as Government College of Engineering and
                  Technology. Later graduate courses in Chemical Engineering
                  (1965), Architecture (1984), Electronics (1985), Information
                  Technology, Computer Science and Technology (2000),
                  Biotechnology, Biomedical Engineering (2003) were also
                  started. In view of its great past with 50 years old record of
                  excellence and several strengths, the institute has been
                  declared as National Institute of Technology (NIT) by the
                  Central Government on 1st Dec. 2005.
                </p>
              </div>
