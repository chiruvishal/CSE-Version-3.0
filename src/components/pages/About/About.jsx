    ...
    <>
      ...
      <div>
        <div
          ...
          style={{
            backgroundImage:
              "url(https://i.postimg.cc/y6jjYM48/Untitled-design-2.png)",
          }}
        >
          ...
          <div class="drop">
            ...
            <div className="Aiml">
              ...
              <div className="flexi flex-colw space-y-6 rounded-lg bg-light-purple overflow-hidden shadow-md md:flex-row md:space-y-0 md:space-x-6">
                ...
                >
                  <p className="mess">
                    The first President of independent India honorable
                    Dr.Rajendra Prasad laid the Foundation stone of the college
                    building on 14 th September 1956. The construction work was
                    completed in 1962 and inauguration was on 14 th March 1963
                    by India 's first Prime Minister Pt. Jawaharlal Nehru. After
                ...
                <p class="ab">
                  ...
                  fields of Mining and Metallurgical Engineering.In view of this
                  fact and also with an aim of harnessing the ample mineral
                  resources of the region, this institute was set - up on 1 st
                  May 1956 as Government College of Mining and Metallurgy.The
                  first session of the college commenced from 1 st July 1956
                  ...
                  Technology.Later graduate courses in Chemical
                  Engineering(1965), Architecture(1984), Electronics(1985),
                  Information Technology, Computer Science and Technology(2000),
                  ...
                  Central Government on 1 st Dec .2005.{" "}
                </p>{" "}
              </div>{" "}
              {/* </div> */}{" "}
            </div>{" "}
        ...
        {/* <h1 className="consulting">Publications</h1> */} {/* <Footer /> */}{" "}
      </div>{" "}
    </>
  );
}
