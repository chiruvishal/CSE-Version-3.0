  ...
  const facultyMembers = [
    {
      ...
      Qualification:
        "Ph.D. (Computer Science & Engineering), M.Tech. (Information Technology with Specialization in Artificial Intelligence), B.E. (Computer Science & Engineering)",
    ...
    },
    {
      ...
      Department: "Computer Science and Engineering",
      Qualification:
        "B.E. (Hons - CS&E), M.Tech. - IT (ABV-IIITM Gwalior), Ph.D. - CS&E (NIT Raipur)",
    ...
    },
    {
      ...
      Department: "Computer Science and Engineering",
      Qualification:
        "Ph.D. (Computer Science & Engineering), M.Tech. (Honours- Computer Science & Engineering), B.E. (Honours-Computer Science & Engineering)",
    ...
    },
    {
      ...
      Department: "Computer Science and Engineering",
      Qualification:
        "BTech(CSE)- MMMEC , MTech(Hons-Systems Engg)-IIT BHU , Ph.D (IT)-NIT Raipur",
    ...
    },
    {
      ...
      Department: "Computer Science and Engineering",
      Qualification:
        "Postdoc (CSE, IIT Guwahati), PhD (CSE, MNIT Jaipur), MTech (CSE, MNIT Jaipur)",
      Designition: "Associate Professor",
                    ...
                    {publishs.map((publish, index) =>
                      index === 1 ? (
                        <div className="Aimli">
                          <button
                            key={index}
                            className="drop-button drop-button-animation"
